# Generated by Django 6.0.5 on 2026-06-01 07:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("db", "0002_mynew_students_useraccount"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sex",
                    models.CharField(default="男", max_length=5, verbose_name="性别"),
                ),
                ("email", models.EmailField(max_length=30, verbose_name="邮箱")),
                (
                    "birth",
                    models.DateField(
                        default="2026-06-01", max_length=20, verbose_name="出生日期"
                    ),
                ),
                (
                    "edu",
                    models.CharField(default="本科", max_length=5, verbose_name="学历"),
                ),
                ...
                (
                    "experience",
                    models.TextField(
                        blank=True, null=True, verbose_name="学习或工作经历"
                    ),
                ),
                (
                    "photo",
                    models.ImageField(
                        upload_to="contact/recruit/%Y_%m_%d", verbose_name="个人照片"
                    ),
                ),
                (
                    "status",
                    models.IntegerField(
                        choices=[(1, "未审"), (2, "通过"), (3, "未通过")],
                        default=1,
                        verbose_name="面试成绩",
                    ),
                ),
